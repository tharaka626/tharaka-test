<script setup>
  ...
  const { bed_type,getBedType,updateBedType,errors } = useBedTypes() 
  ...
  onMounted(async () => {await getBedType(props.id); isMounted.value = true})

</script>

<template>
  <form class="bg-white max-w-4xl mx-auto p-4 grid justify-center" @submit.prevent="updateBedType($route.params.id)">
      ...
      <div class="border-b border-gray-900/10 pb-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <TextInput v-model="bed_type.name" />
            </div>
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              ...
              <SelectInput v-if="isMounted" v-model="bed_type.status" :name="'status'" :options="selectOptions"/>
            </div>
